            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <form action="{{ route('intervensi-khususes.approve', $intervensiKhusus) }}" method="POST">
                        ...
                        <!-- jika status sudah disetujui maka akan muncul tombol untuk melihat progress -->

                        <!-- /.card -->
                    </form>
                </div>
                @if ($intervensiKhusus->status == 2)
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-2">
                            <a class="btn btn-block btn-primary btn-xs" href="{{ route('intervensi-khususes.progress-intervensi-khususes.index', $intervensiKhusus) }}">Lihat
                                Progres</a>
                        </div>
                    </div>
