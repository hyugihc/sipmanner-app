...
<section class="content">
    ...
    <div class="alert alert-info alert-dismissible">
        ...
        Saat ini pelaporan progres di Sipmanner <b>tidak perlu persetujuan Change Leader lagi.</b> Status progres berubah menjadi Tersubmit ketika sudah disubmit di Sipmanner. Change Champion dapat mengupdate data yang sudah terinput
    </div>
                    ...
                    <table class="table table-hover" id="table_piks">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-block btn-primary btn-xs" href="{{ route('intervensi-khususes.progress-intervensi-khususes.index', $intervensiKhusus) }}">Show
                                        Progress</a>
                                </td>
                            </tr>
                            @php
