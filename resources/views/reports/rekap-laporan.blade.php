                    ...
                    <table class="table table-hover" id="laporan-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @can('view', $report)
                                    <a class="btn btn-block btn-primary btn-xs" href="{{ route('reports.show', $report) }}">Show</a>
                                    @endcan
                                    {{-- @if ($report->status == 2)
                                    ...
                                    @endif --}}
                                    @can('update', $report)
                                    <a class="btn btn-block btn-warning btn-xs" href="{{ route('reports.edit', $report) }}">Edit</a>
                                    @endcan
                            ...
                            <td>
                                @can('view', $reportSm1)
                                <a class="btn btn-block btn-primary btn-xs" href="{{ route('reports.show', $reportSm1) }}">Show</a>
                                @endcan
                                @can('update', $reportSm1)
                                <a class="btn btn-block btn-warning btn-xs" href="{{ route('reports.edit', $reportSm1) }}">Edit</a>
                                @endcan
                            </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    @can('view', $reportSm2)
                                    <a class="btn btn-block btn-primary btn-xs" href="{{ route('reports.show', $reportSm2) }}">Show</a>
                                    @endcan
                                    @can('update', $reportSm2)
                                    <a class="btn btn-block btn-warning btn-xs" href="{{ route('reports.edit', $reportSm2) }}">Edit</a>
                                    @endcan
                                </td>
                                @endif
                            </tr> --}}
        ...
        <div class="modal-dialog">
            <div class="modal-content bg-primary">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-outline-light" href="{{ route('reports.create.laporan', [Auth::user()->getSetting('tahun'), '1']) }}">Semester
                        1 tahun {{ Auth::user()->getSetting('tahun') }}</a>
                    <a class="btn btn-outline-light" href="{{ route('reports.create.laporan', [Auth::user()->getSetting('tahun'), '2']) }}">Semester
